...
// const CartPage: React.FC = () => {
//   const { cart, removeFromCart, updateCartQuantity, setCart } = useCart();
//   const { wishlist, addToWishlist, removeFromWishlist } = useWishlist();
//   const [successMessage, setSuccessMessage] = useState<string | null>(null);
//   const { isLoaded, isSignedIn } = useAuth();
//   const router = useRouter();

//   // ✅ Load Cart from Local Storage (for persistence after refresh)
//   useEffect(() => {
...
//   // ✅ Redirect After Sign-In to Checkout
//   const handleCheckout = () => {
//     if (!isLoaded) return;
//     if (!isSignedIn) {
//       router.push("/sign-in?redirect_url=/checkout"); // Redirect to sign-in and return to checkout
//     } else {
...
//                 className="mt-6 w-full bg-teal-500 text-white py-3 rounded-full text-lg font-medium hover:bg-teal-600 transition"
//               >
//                 Checkout
//               </button>
//             </div>
...
const CartPage: React.FC = () => {
  ...
  // ✅ Redirect After Sign-In to Checkout & Clear Cart
  const handleCheckout = () => {
    if (!isLoaded) return;
    if (!isSignedIn) {
      router.push("/sign-in?redirect_url=/checkout"); // Redirect to sign-in and return to checkout
